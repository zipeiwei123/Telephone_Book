...
setup(
  name = 'phonewordzp',         # How you named your package folder (MyLib)
  packages = ['phonewordzp'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/zipeiwei123/Telephone_Book/archive/v0.5.tar.gz',    # I explain this later on
